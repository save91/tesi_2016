...
\newpage
\section{NodeJS}
Node.js\cite{node} è un interprete JavaScript orientato agli eventi, progettato per realizzare applicazioni di rete scalabili.
Per  ogni connessioni in ingresso viene chiamata la relativa callback, ma se non c'è nessun niente da fare Node rimane inattivo.
